...
//    $CFG->legacyadminsettingsmenu = true;
    ...
    // Uncache legacy-only front end dependencies
    $CFG->cachejs = false;
    ...
    // When you expact fresh data from GraphQL, disable the cache,
    ...
    // during development. They do similar things to the legacvy-only
